        ...
        <div class="col-xs-12 col-md-6 col-md-offset-3">
            <form method = 'POST' action = '{!!url("proveedor")!!}'>
                ...
                <div class="form-group">
                    ...
                    <input id="lead_time_proveedor" name = "lead_time_proveedor" type="text" class="form-control" required placeholder="Leed Time Proveedor">
                </div>
                <div class="form-group">
                    <label for="tiempo_entrega_proveedor">Tiempo de entrega de Proveedor</label>
                    <input id="tiempo_entrega_proveedor" name = "tiempo_entrega_proveedor" type="text" class="form-control" required placeholder="Tiempo de entrega de Proveedor">
                </div>
