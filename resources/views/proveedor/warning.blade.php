...
<section class="content">
    ...
    <br>
    <div class="row">
        <div class="col-xs-6"><a href='{!!url("proveedor")!!}' class = 'btn btn-primary'><i class="fa fa-home"></i> Lista de Proveedores</a></div>
        <div class="col-xs-6 pull-right">
            {{-- <a href='{!!url("import")!!}' class = 'btn btn-success'><i class="fa fa-exclamation-circle" aria-hidden="true"></i> Sí. Estoy seguro.</a> --}}
            <form style="display:inline-block;" method = 'POST' action = '{!!url("proveedor/import")!!}' enctype="multipart/form-data">
